<script lang="ts">
  ...
  const styles = {
    normal:
      'border-gray-300 dark:border-gray-500 bg-white dark:bg-black hover:bg-accent-50 dark:hover:border-gray-600 dark:hover:bg-gray-800 focus:ring-accent-500 dark:focus:ring-accent-700 ',
    primary:
